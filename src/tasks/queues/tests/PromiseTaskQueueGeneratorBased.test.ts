...
import { PromiseTaskQueueGeneratorBased } from "../PromiseTaskQueueGeneratorBased";

describe("PromiseTaskQueueGeneratorBased", () => {
  ...
  describe("enqueue", () => {
    it("should run tasks sequentially", async () => {
      const mockPromiseQueue = new PromiseTaskQueueGeneratorBased();
  ...
  it.skip("should dispatch 'queuefinished' when queue is finished", async () => {
    const mockPromiseQueue = new PromiseTaskQueueGeneratorBased();
  ...
  it.skip("should correctly return isRunning state", async () => {
    const mockPromiseQueue = new PromiseTaskQueueGeneratorBased();
